...
/// Dialogue pour ajouter manuellement une session de port d'appareil.
///
/// Permet de spécifier la date, l'heure de début, la durée et optionnellement un sticker.
class AddManualSessionDialog extends ConsumerStatefulWidget {
  const AddManualSessionDialog({super.key});

  @override
  ConsumerState<AddManualSessionDialog> createState() =>
      _AddManualSessionDialogState();
}

class _AddManualSessionDialogState
    extends ConsumerState<AddManualSessionDialog> {
